...
namespace RFID
{
    public class SWNetApi
    {
        ...
        /*********************************************************/
        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        */
        ...
        public delegate void callBackHandler(int msg, int param1, [MarshalAs(UnmanagedType.LPArray, SizeConst = 2048)]byte[] param2, int param3, [MarshalAs(UnmanagedType.LPArray, SizeConst = 10)]byte[] param4);
        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void SWNet_SetCallback(callBackHandler fun1);
